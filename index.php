...
<!-- Mirrored from themelooks.us/demo/socifly/html/home-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Apr 2018 10:37:03 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!-- ==== Document Title ==== -->
    <title>TieNet - Community App</title>
...
<body>
    ...
    <div class="wrapper">
                    ...
                    <div id="headerNav" class="navbar-collapse collapse float--right">
                        ...
                        <ul class="header--nav-links style--1 nav ff--primary">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="activity.html"><span>School</span></a></li>
                                    <li><a href="members.html"><span>NGO</span></a></li>
                                    <li><a href="members.html"><span>Business</span></a></li>
                                    <li><a href="members.html"><span>College</span></a></li>
                                </ul>
                            </li>
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
        ...
        <div class="container">
            <div class="row how_our_site_works">
                <div class="col-sm-12 col-lg-4 col-md-4 col-xs-12 how_our_site_works_container">
                    <div class="column-inner how_our_site_works_container_text">
                        <div class="wpb_wrapper">
                            <div style="font-size: 24px;color: #2f3444;line-height: 28px;text-align: left;font-family:Roboto;font-weight:700;font-style:normal" class="vc_custom_heading vc_custom_1509043234081 bb_custom_1509043226888 bb_custom_1509043226888 bbvcedo-lsi bbvcedo-tai">How our site works</div>
                            <div style="font-size: 16px;color: #777777;line-height: 24px;text-align: left;font-family:Roboto;font-weight:400;font-style:normal" class="vc_custom_heading bb_custom_1509012292945 bbvcedo-tai">Professionally supply compelling results without client-centered infrastructures. Dynamically visualize value-added e-commerce after superior testing procedures.</p>
                                <p>Collaboratively coordinate premier partnerships rather than empowered supply chains. Phosfluorescently matrix stand-alone e-business before 24/7 portals.</p>
                                <p>Holisticly re-engineer covalent e-services with reliable platforms. Globally re-engineer web-enabled functionalities without go forward results. Energistically expedite go forward networks before enterprise information.</div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12 col-lg-8 col-md-8 col-xs-12">
                    <div class="column-inner">
                        <div class="wpb_wrapper">
                            <div class="wpb_video_widget wpb_content_element vc_clearfix   vc_custom_1509043522322 vc_video-aspect-ratio-169 vc_video-el-width-100 vc_video-align-center">
                                <div class="wpb_wrapper">
                                    <div class="wpb_video_wrapper">
                                        <iframe src="https://player.vimeo.com/video/145154247" width="100%" height="410" frameborder="0" title="Speed Dating" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="app-images">
            <div class="container">
                <div class="row"> 
                    ...
                    <!-- APP IMAGE -->
                <div class="col-md-6 text-right"><img src="img/app-img.png" alt="" > </div>
                </div>
            </div>
        </section>
        ...
        <!-- sponsors -->
        <div class="sponsors" style="background:url(img/sponser-bg.jpg) no-repeat;">
          <div class="container">
            <div class="row">
              <div class="col-md-12">
                <h3 class="section-title">Our Sponsors</h3>
                <div class="sponsors-slider">
                  <div class="item"><img src="img/sponsor_logo1.png" alt="" class="img-responsive"></div>
                  <div class="item"><img src="img/sponsor_logo2.png" alt="" class="img-responsive"></div>
                  <div class="item"><img src="img/sponsor_logo3.png" alt="" class="img-responsive"></div>
                  <div class="item"><img src="img/sponsor_logo4.png" alt="" class="img-responsive"></div>
                  <div class="item"><img src="img/sponsor_logo5.png" alt="" class="img-responsive"></div>
                  <div class="item"><img src="img/sponsor_logo6.png" alt="" class="img-responsive"></div>
                  <div class="item"><img src="img/sponsor_logo4.png" alt="" class="img-responsive"></div>
                </div>
              </div>
            </div>
...
<!-- Mirrored from themelooks.us/demo/socifly/html/home-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Apr 2018 10:37:30 GMT -->
</html>